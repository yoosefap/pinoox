...
const MESSAGES = {
    fa: {
        ...
        app_details_addresses_empty_add_hint: 'یک آدرس عمومی برای بازدیدکننده‌ها تعریف کنید تا برنامه از مرورگر باز شود.',
        app_details_add_route: 'افزودن آدرس',
        ...
        app_secret_view: 'مشاهده خصوصی',
        app_back: 'بازگشت',
        app_not_found_title: 'مدیریت اپ',
    ...
    en: {
        ...
        app_details_addresses_empty_add_hint: 'Assign a public URL so visitors can open this app in the browser.',
        app_details_add_route: 'Add address',
        ...
        app_run: 'Open app',
        app_secret_view: 'Private preview',
        app_back: 'Back',
        app_not_found_title: 'App manager',
