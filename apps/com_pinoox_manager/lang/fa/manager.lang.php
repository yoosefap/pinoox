...
return [
    ...
    'package_name_invalid' => 'نام پکیج «{name}» معتبر نیست. فرمت: {hint}',
    ...
    'db_prefix_hint' => 'پیشوند دلخواه در app.php حفظ می‌شود. پیشنهاد سیستم مثل route از app slug است؛ فقط در تداخل خودکار اصلاح می‌شود.',
    ...
    'database_error_missing_name' => 'نام دیتابیس را وارد کنید.',
    'database_error_credentials' => 'نام کاربری یا رمز عبور دیتابیس اشتباه است.',
    'database_error_not_found' => 'دیتابیس با این نام پیدا نشد.',
    'database_error_database_access' => 'این کاربر اجازه دسترسی به این دیتابیس را ندارد.',
    'database_error_host_denied' => 'سرور دیتابیس اجازه اتصال از این آدرس را نمی‌دهد.',
    'database_error_server_unreachable' => 'اتصال به سرور دیتابیس برقرار نشد. میزبان و پورت را بررسی کنید.',
    'database_error_host_invalid' => 'آدرس میزبان دیتابیس نامعتبر است.',
    'database_error_sqlite_path' => 'فایل دیتابیس SQLite قابل دسترسی نیست.',
