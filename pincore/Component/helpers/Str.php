...
class Str
{
    ...
    public static function multiExplode(array $delimiters, Str $string): array|bool
    {
    ...
    public static function replaceData()
    {
        ...
        if (is_array($replaces)) {
            foreach ($replaces as $key => $replace) {
                $replace = is_array($replace) ? Str::encodeJson($replace) : $replace;
